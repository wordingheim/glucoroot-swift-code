    ...
    var body: some View {
        /*HStack {
            Button(action:{
                ...
                Image(isChecked ? "checkedsmall" : "uncheckedsmall")
            }
            Text(text)
        }*/
        Button(action: {
            ...
            VStack{
                ...
                HStack{
                    ...
                    .background(
                        Rectangle()
                            .fill(maincolor)
                            .opacity((self.selectionInd == -1) ? 0.4 : 1)
                        )
                    .padding(6)
                    .disabled(self.selectionInd == -1)
...
#Preview {
    PageVTestWrapper() // Use the wrapper to test the state
}
